...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow) {
    ...
    connect(ui->pushButton_4, &QPushButton::clicked, this, &MainWindow::FilterButtonClicked);
...
void MainWindow::FilterButtonClicked() {
    bool ok;
    QString filter = QInputDialog::getText(this, tr("Задать фильтр"),
                                           tr("Введите BPF-фильтр:"), QLineEdit::Normal,
                                           "", &ok);
...
void MainWindow::SettingsButtonClicked() {
    ...
    memoryLimitInput->setPlaceholderText("Введите лимит ОЗУ для работы DuckDB (MB)");
...
void MainWindow::TutorialButtonClicked() {
    QMessageBox::information(this, "Руководство",
                           "Фильтрация на уровне pcap сохранена на уровне Berkley. Для задания пустого фильтра, введите none\n\n"
                           "Руководство по эксплуатации pcap можно найти на сайте https://www.winpcap.org/install/\n"
...
void MainWindow::StartSniffing(const QString &device) {
    ...
    connect(this, &MainWindow::filterChanged, sniffer.get(), &SnifferMonitoring::setFilter);
    connect(sniffer.get(), &SnifferMonitoring::showMessage,
            this, [](const QString &title, const QString &text, QMessageBox::Icon icon) {
